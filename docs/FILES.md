...
| `test_annotations.py` | The UI vocabulary: header, columns, filter bar and capabilities in both encodings, that every annotated path is a real property, and that the V2 services keep their `sap:` attributes instead. |
